...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay:(NSDictionary *)dic
{

    //订单标题，展示给用户
    NSString *order_name    = dic[@"auctionName"];
    //订单金额,单位（分
    
    NSString *order_price   = [NSString stringWithFormat:@"%@",dic[@"paymentPrice"]];

    NSString *orserNumber = dic[@"orderNum"];
    ...
    NSString *orderno   = dic[@"orderNum"];
    YCLog(@"orderno----%@",orderno);
    ...
    [packageParams setObject: orserNumber           forKey:@"out_trade_no"];//商户订单号
