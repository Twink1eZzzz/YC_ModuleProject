...
- (void)configCollectionView {
    ...
    YCGridViewFlowLayout *layout = [[YCGridViewFlowLayout alloc] init];
    _margin = 4;
    ...
    [_collectionView registerClass:[YCTestCell class] forCellWithReuseIdentifier:@"YCTestCell"];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    YCTestCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"YCTestCell" forIndexPath:indexPath];
