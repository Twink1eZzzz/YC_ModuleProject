...
@interface YCGridViewFlowLayout () <UIGestureRecognizerDelegate>
...
@implementation YCGridViewFlowLayout
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            YCTestCell *sourceCell = (YCTestCell *)sourceCollectionViewCell;
