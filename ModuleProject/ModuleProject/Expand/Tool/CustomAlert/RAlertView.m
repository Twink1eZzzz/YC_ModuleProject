...
-(void)prepareData{
    ...
    self.themeArray = @[HEXCOLOR(0X1abc9c),
                        HEXCOLOR(0X27ae60),
                        HEXCOLOR(0X2980b9),
                        HEXCOLOR(0X2c3e50),
                        HEXCOLOR(0Xf39c12),
...
-(void)animateSenior{
    ...
    self.mainView.transform = CGAffineTransformMakeTranslation(0, 600);
    [UIView animateWithDuration:0 delay:0 usingSpringWithDamping:0.35 initialSpringVelocity:0.5 options:UIViewAnimationOptionCurveLinear animations:^{
        self.mainView.transform = CGAffineTransformMakeTranslation(0, 0);
...
-(UIButton *)confirmButton{
    if(_confirmButton == nil){
        ...
        [_confirmButton setBackgroundColor:HEXCOLOR(0Xfddb43)];
        [_confirmButton setTitle:@"Ok" forState:UIControlStateNormal];
        [_confirmButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [_confirmButton setTitleColor:HEXCOLOR(0X3d3d3d) forState:UIControlStateNormal];
...
-(UIButton *)cancelButton{
    if(_cancelButton == nil){
        ...
        [_cancelButton setBackgroundColor:HEXCOLOR(0XEBECED)];
        [_cancelButton setTitle:@"Cancel" forState:UIControlStateNormal];
        [_cancelButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [_cancelButton setTitleColor:HEXCOLOR(0X3d3d3d) forState:UIControlStateNormal];
...
-(UILabel*)headerTitleLabel {
    if (_headerTitleLabel == nil) {
        ...
        [_headerTitleLabel setTextColor:HEXCOLOR(0X3d3d3d)];
    }
...
-(UILabel*)contentTextLabel {
    if (_contentTextLabel == nil) {
        ...
        [_contentTextLabel setTextColor:HEXCOLOR(0X898989)];
